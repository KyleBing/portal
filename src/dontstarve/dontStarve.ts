...
router.post('/character/add', (req, res) => {
    verifyAuthorization(req)
        .then(userInfo => {
            ...
            operate_db_and_return_added_id(userInfo.uid, DB_NAME, DATA_NAME_CHARACTER, sqlArray, '添加', res)
        })
        .catch(errInfo => {
            res.send(new ResponseError('', errInfo))
        })
    ...
    verifyAuthorization(req)
        .then(userInfo => {
            if (!req.body.name || !req.body.name_en || !req.body.version) {
                res.send(new ResponseError('', '名称、英文名称和版本不能为空'))
                return
            }
    ...
    verifyAuthorization(req)
        .then(userInfo => {
            if (!req.body.name || !req.body.name_en || !req.body.version || !req.body.crafting) {
                res.send(new ResponseError('', '名称、英文名称、版本和制作材料不能为空'))
                return
            }
            ...
            operate_db_and_return_added_id(userInfo.uid, DB_NAME, DATA_NAME_CRAFT, sqlArray, '添加', res)
        })
        .catch(errInfo => {
            res.send(new ResponseError('', errInfo))
        })
    ...
    verifyAuthorization(req)
        .then(userInfo => {
            if (!req.body.name || !req.body.name_en || !req.body.version || !req.body.kind || !req.body.size) {
                res.send(new ResponseError('', '名称、英文名称、版本、类型和大小不能为空'))
                return
            }
            ...
            operate_db_and_return_added_id(userInfo.uid, DB_NAME, DATA_NAME_MOB, sqlArray, '添加', res)
        })
        .catch(errInfo => {
            res.send(new ResponseError('', errInfo))
        })
...
router.post('/plant/add', (req, res) => {
    verifyAuthorization(req)
        .then(userInfo => {
            ...
            operate_db_and_return_added_id(userInfo.uid, DB_NAME, DATA_NAME_PLANT, sqlArray, '添加', res)
        })
        .catch(errInfo => {
            res.send(new ResponseError('', errInfo))
        })
...
router.post('/thing/add', (req, res) => {
    verifyAuthorization(req)
        .then(userInfo => {
            ...
            operate_db_and_return_added_id(userInfo.uid, DB_NAME, DATA_NAME_THING, sqlArray, '添加', res)
        })
        .catch(errInfo => {
            res.send(new ResponseError('', errInfo))
        })
