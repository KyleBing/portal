import {getDataFromDB, unicodeDecode, updateUserLastLoginTime, verifyAuthorization} from "../../config/utility";
import express = require("express")
const routerDiaryBankCard = express.Router()

import {Response, Request} from "express";
import {ResponseError} from "../../response/ResponseError";
import {ResponseSuccess} from "../../response/ResponseSuccess";
import {DiaryEntity} from "./DiaryEntity";
routerDiaryBankCard.get('/', (req: Request, res: Response, next) => {
